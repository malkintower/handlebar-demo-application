...
class View_Examples_Sections extends View_Examples_Template
{
	public $example_title = 'Sections Example';
	...
	function template()
	{
		return parent::get_template('examples/sections');
	}
	...
	function output()
	{
		return parent::get_output('examples/sections');
	}
